...
"""
passwd = long_to_bytes(
    (
        ASCIS_coconut_52_BIGNUMBER(coconut_water03)
        * inverse(
            ASCIS_coconut_52_BIGNUMBER(coconut_water01),
            ASCIS_coconut_52_BIGNUMBER(coconut_water02),
        )
    )
    % ASCIS_coconut_52_BIGNUMBER(coconut_water02)
)
...
open("flag1.png", "wb").write(
    ASCIS_decrypt_flag1(passwd, AESiv, AESCipher)
)  # DECRYPT FLAG 1
...
# StackFrame2: System.Object Invoke(System.Object, System.Reflection.BindingFlags, System.Reflection.Binder, System.Object[], System.Globalization.CultureInfo)
# StackFrame1: System.Object InvokeMethod(System.Object, System.Object[], System.Signature, Boolean)
ARC4Cipher = open("DRAGON_WARRIOR", "rb").read()
print("Key2: " + ARC4key.decode())
open("flag2.png", "wb").write(
    ASCIS_decrypt_flag2(ARC4key, ARC4Cipher)
)  # DECRYPT FLAG 2
